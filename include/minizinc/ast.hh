...
public:
  ...
  struct {
    ...
    ASTString mzn_internal_array_elem_in;  // NOLINT(readability-identifier-naming)
    ...
    struct {
      ...
      ASTString bool_lin_eq;   // NOLINT(readability-identifier-naming)
      ASTString bool_lin_le;   // NOLINT(readability-identifier-naming)
      ASTString float_lin_eq;  // NOLINT(readability-identifier-naming)
      ASTString float_lin_lt;  // NOLINT(readability-identifier-naming)
    } fznso;
