  ...
  public:
    ...
    void vCall(Call& c) {
      if (c.id() == "outputJSON") {
        ...
        Expression* json =
            copy(env, env.cmap, createJSONOutput(env, outputObjective, false, false));
...
void createDznOutputItem(EnvI& e, bool outputObjective, bool includeOutputItem, bool hasChecker,
  ...
  public:
    DZNOVisitor(EnvI& e0, bool outputObjective0, bool includeOutputItem0, bool outputForChecker0,
                std::vector<Expression*>& outputVars0)
        : e(e0),
          outputObjective(outputObjective0),
          includeOutputItem(includeOutputItem0),
          outputForChecker(outputForChecker0),
