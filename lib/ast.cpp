...
Constants::Constants() {
  ...
  ids.fznso.bool_lin_eq = addString("fzn_bool_lin_eq");
  ids.fznso.bool_lin_le = addString("fzn_bool_lin_le");
  ids.fznso.float_lin_eq = addString("fzn_float_lin_eq");
  ids.fznso.float_lin_lt = addString("fzn_float_lin_lt");
  ...
  ids.bool_.lin_eq = addString("bool_lin_eq");
  ids.bool_.lin_le = addString("bool_lin_le");
