...
{
  "$end", "error", "$undefined", "R_INTEGER", "\"(\"", "\")\"", "\"*\"",
  "\"+\"", "\".\"", "\"|\"", "\"?\"", "\"{\"", "\"}\"", "\",\"", "\"[\"",
  "\"]\"", "\"-\"", "\"^\"", "R_IDENTIFIER", "$accept", "regex",
  "expression", "term", "factor", "atom", "set_items", "set_item",
  "literal", YY_NULLPTR
};
#endif
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, REContext& ctx)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (ctx);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, REContext& ctx)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, REContext& ctx)
{
  YYUSE (yyvaluep);
  YYUSE (ctx);
  if (!yymsg)
