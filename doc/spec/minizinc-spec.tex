...
%      arrays, tuples, records, enumerated types, constrained type-insts);
...
\Rationale{This restriction naturally follows from the decision to disallow
recursive functions and predicates (see Section~\ref{Basic Properties}).
Without such capabilities, recursive data structures are of little use as
there is no general way to traverse them.}
...
each case (e.g.~\texttt{Australia} and \texttt{float\n{}point}) is
