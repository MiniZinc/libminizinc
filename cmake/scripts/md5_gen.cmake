...
# The tree-sitter grammars are not generated by anything this script rebuilds:
# their sums only change when update-tree-sitter.sh has regenerated the parser,
# and recomputing them here would bless an edited grammar.js that no longer
# matches the vendored parser.c. Carry the included values through unchanged.
foreach(ts_grammar minizinc datazinc)
	set(MD5_TEMPLATE
	    "${MD5_TEMPLATE}\nset(ts_${ts_grammar}_grammar_js_md5_cached \"${ts_${ts_grammar}_grammar_js_md5_cached}\")")
endforeach()
