...
include(../../lib/cached/md5_cached.cmake)

MD5("../../lib/lexer.lxx" lexer_lxx_md5)
MD5("../../lib/parser.yxx" parser_yxx_md5)
MD5("../../lib/support/regex/lexer.lxx" regex_lexer_lxx_md5)
MD5("../../lib/support/regex/parser.yxx" regex_parser_yxx_md5)


if(FORCE OR (NOT "${lexer_lxx_md5}" STREQUAL "${lexer_lxx_md5_cached}"))
  file(COPY "${PROJECT_BINARY_DIR}/lexer.yy.cpp" DESTINATION "../../lib/cached")
endif()
if(FORCE OR (NOT "${parser_yxx_md5}" STREQUAL "${parser_yxx_md5_cached}"))
  file(COPY "${PROJECT_BINARY_DIR}/parser.tab.cpp" DESTINATION "../../lib/cached")
  file(COPY "${PROJECT_BINARY_DIR}/include/minizinc/parser.tab.hh" DESTINATION "../../lib/cached/minizinc")
endif()
if(FORCE OR (NOT "${regex_lexer_lxx_md5}" STREQUAL "${regex_lexer_lxx_md5_cached}"))
  file(COPY "${PROJECT_BINARY_DIR}/regex_lexer.yy.cpp" DESTINATION "../../lib/cached")
endif()
if(FORCE OR (NOT "${regex_parser_yxx_md5}" STREQUAL "${regex_parser_yxx_md5_cached}"))
  file(COPY "${PROJECT_BINARY_DIR}/regex_parser.tab.cpp" DESTINATION "../../lib/cached")
  file(COPY "${PROJECT_BINARY_DIR}/include/minizinc/support/regex_parser.tab.hh" DESTINATION "../../lib/cached/minizinc/support")
endif()
...
file(WRITE "../../lib/cached/md5_cached.cmake" ${MD5_TEMPLATE})
