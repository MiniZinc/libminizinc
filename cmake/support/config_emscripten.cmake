...
if (DEFINED EMSCRIPTEN)
  ...
  set_target_properties(minizinc PROPERTIES LINK_FLAGS "-s EXPORT_NAME=MINIZINC -s FORCE_FILESYSTEM=1 -s MODULARIZE=1 -s EXTRA_EXPORTED_RUNTIME_METHODS=\"['cwrap', 'FS', 'ENV']\"")
endif()
...
if (DEFINED EMSCRIPTEN)
  ...
  set_target_properties(minizinc_asm PROPERTIES LINK_FLAGS "-s EXPORT_NAME=MINIZINC -s WASM=0 -s FORCE_FILESYSTEM=1 -s MODULARIZE=1 -s EXTRA_EXPORTED_RUNTIME_METHODS=\"['cwrap', 'FS', 'ENV']\"")
endif()
