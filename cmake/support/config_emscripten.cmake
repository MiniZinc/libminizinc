...
if (DEFINED EMSCRIPTEN)
  ...
  set_target_properties(minizinc PROPERTIES LINK_FLAGS "-s EXPORT_NAME=MINIZINC -s DISABLE_EXCEPTION_CATCHING=0 -s FORCE_FILESYSTEM=1 -s MODULARIZE=1 -s EXTRA_EXPORTED_RUNTIME_METHODS=\"['cwrap', 'FS', 'ENV']\"")
endif()
...
if (DEFINED EMSCRIPTEN)
  ...
  set_target_properties(minizinc_asm PROPERTIES LINK_FLAGS "-s EXPORT_NAME=MINIZINC -s DISABLE_EXCEPTION_CATCHING=0 -s WASM=0 -s FORCE_FILESYSTEM=1 -s MODULARIZE=1 -s EXTRA_EXPORTED_RUNTIME_METHODS=\"['cwrap', 'FS', 'ENV']\"")
endif()
...
if (DEFINED EMSCRIPTEN)
  ...
  set_target_properties(mzn2doc PROPERTIES LINK_FLAGS "-s EXPORT_NAME=MZN2DOC -s FORCE_FILESYSTEM=1 -s MODULARIZE=1 -s EXTRA_EXPORTED_RUNTIME_METHODS=\"['cwrap', 'FS', 'ENV']\"")
endif()
...
if (DEFINED EMSCRIPTEN)
  ...
  set_target_properties(mzn2doc_asm PROPERTIES LINK_FLAGS "-s EXPORT_NAME=MZN2DOC -s WASM=0 -s FORCE_FILESYSTEM=1 -s MODULARIZE=1 -s EXTRA_EXPORTED_RUNTIME_METHODS=\"['cwrap', 'FS', 'ENV']\"")
endif()
